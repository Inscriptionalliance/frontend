...
export const ChartComponent = (props) => {
  // linear-gradient(91deg, #95FA31 0%, rgb(246, 240, 34) 100%)
  const {
    data,
    colors: {
      ...
      lineColor = "#95FA31",
      textColor = "#fff",
      areaTopColor = "rgba(149, 250, 49, 0.8)",
      areaBottomColor = "rgba(246, 240, 34, 0.5)",
    } = {},
  } = props;
  ...
  useEffect(() => {
    ...
    const chart = createChart(chartContainerRef.current, {
      layout: {
        background: { type: "dashed", color: backgroundColor },
        textColor,
      },
